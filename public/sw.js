...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__build_asset_manifest_json__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_db__ = __webpack_require__(3);
...
function hydrateDB() {
  return fetch('https://us-central1-worldcup18-d9408.cloudfunctions.net/dump')
    ...
    .then(data => {
      ...
      return Promise.all([
        __WEBPACK_IMPORTED_MODULE_1__core_db__["a" /* default */].fixtures.bulkPut(parseFixtures(fixtures)),
        __WEBPACK_IMPORTED_MODULE_1__core_db__["a" /* default */].teams.bulkPut(parseTeams(teams)),
        __WEBPACK_IMPORTED_MODULE_1__core_db__["a" /* default */].groups.bulkPut(parseGroups(groups)),
      ])
    })
...
const db = new __WEBPACK_IMPORTED_MODULE_0_dexie__["a" /* default */]('worldcup18')
db.version(1).stores({
